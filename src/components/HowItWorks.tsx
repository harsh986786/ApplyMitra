          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="relative h-40 overflow-hidden">
                ...
                <div className={`absolute -top-1 -left-1 w-10 h-10 z-10 rounded-xl bg-gradient-to-br ${s.color} text-white font-bold flex items-center justify-center shadow-lg z-10`}>
                  {i + 1}
                </div>
              </div>
              <div className="p-5">
